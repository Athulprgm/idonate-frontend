  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20 font-sans text-slate-800">
      ...
      <div className="pt-6 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto bg-gradient-to-r from-red-600 via-rose-600 to-red-700 text-white rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-12 shadow-xl shadow-red-600/15 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border-slate-200 shadow-sm text-red-600 text-xs font-extrabold uppercase tracking-wider mb-4">
            ...
            {canCreate && (
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-white border-slate-200 shadow-sm text-red-600 font-extrabold text-sm hover:bg-red-50 transition self-start md:self-center shrink-0 border border-white/20"
              >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 mt-6 relative z-10">
        ...
        <div className="bg-white border-slate-200 shadow-sm rounded-2xl border border-red-100 p-4 mb-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 bg-white border-slate-200 shadow-sm border border-red-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
              />
              {searchQuery && (
        ...
        {filteredPosts.length === 0 ? (
          <div className="bg-white border-slate-200 shadow-sm rounded-2xl p-12 text-center border border-red-100 max-w-md mx-auto my-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPosts.map((post) => {
              ...
              return (
                <article
                  key={post.id}
                  className="bg-white border-slate-200 shadow-sm rounded-2xl overflow-hidden border-t-4 border-t-red-600 border-x border-b border-red-100 hover:shadow-xl hover:border-red-300 transition duration-300 flex flex-col justify-between"
                >
                  <div>
                    {/* Cover Banner */}
        ...
        {shareModalPost && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-xs">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.96 }}
              className="bg-white border-slate-200 shadow-sm rounded-2xl p-6 w-full max-w-sm text-center border border-red-100 shadow-2xl"
            >
              ...
              <div className="mt-5 space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-white border-slate-200 shadow-sm hover:bg-red-50 text-red-600 border border-red-200 font-bold text-xs rounded-xl transition"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center gap-3">
                ...
                <button
                  onClick={() => setViewModalPost(null)}
                  className="px-6 py-3 bg-white border-slate-200 shadow-sm border hover:bg-slate-100 text-slate-700 font-bold text-sm rounded-xl transition"
                >
                  Close
                </button>
              </div>
