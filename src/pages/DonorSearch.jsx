...
export default function DonorSearch() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 text-left">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-red-700 via-rose-700 to-red-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-red-900/10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <button
            ...
            className="px-4 py-3 bg-white border-slate-200 shadow-sm text-red-700 hover:bg-red-50 text-xs font-black rounded-2xl transition-all cursor-pointer flex items-center justify-center gap-2 shrink-0 self-start md:self-auto"
          >
      ...
      <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border /80 dark:border-zinc-800 rounded-3xl p-6 space-y-5">
        {/* Top Search Bar */}
      ...
      {paginated.length === 0 ? (
        <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border /80 dark:border-zinc-800 rounded-3xl p-12 text-center text-slate-400 dark:text-zinc-500">
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2 pt-4">
          <button
            ...
            disabled={page === 1}
            className="px-4 py-2.5 text-xs font-bold border dark:border-zinc-800 text-slate-700 dark:text-zinc-300 bg-white border-slate-200 shadow-sm dark:bg-zinc-900 rounded-2xl disabled:opacity-40 hover:border-red-300 transition-colors cursor-pointer"
          >
            Previous
          </button>
