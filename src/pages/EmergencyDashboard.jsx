...
export default function EmergencyDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-800 dark:text-zinc-100 p-4 lg:p-6 space-y-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-10 h-10 bg-white border-slate-200 shadow-sm/15 border border-white/25 rounded-2xl flex items-center justify-center">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 bg-white border-slate-200 shadow-sm text-red-700 font-bold rounded-2xl text-xs transition-all cursor-pointer hover:bg-red-50"
            >
              <Plus className="w-3.5 h-3.5" /> Dispatch Alert
            </button>

            {/* Export items */}
            <div className="flex bg-white border-slate-200 shadow-sm/10 border border-white/20 rounded-2xl p-0.5">
              <button
                onClick={exportToCSV}
                className="p-2 hover:bg-white border-slate-200 shadow-sm/10 rounded-xl text-white/80 hover:text-white cursor-pointer transition-colors"
                title="Export to CSV"
              >
      ...
      <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 text-left">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-5 text-left">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-5 text-left">
        ...
        <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-5 text-left flex flex-col justify-between">
          <div>
        ...
        {showRequestModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div 
              ...
              className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-850 rounded-3xl p-6 max-w-md w-full shadow-2xl text-left"
            >
        ...
        {selectedRequest && emergencyDetails && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div 
              ...
              animate={{ scale: 1, opacity: 1 }} 
              exit={{ scale: 0.95, opacity: 0 }} 
              className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-850 rounded-3xl p-6 max-w-lg w-full shadow-2xl text-left flex flex-col max-h-[90vh]"
            >
                    ...
                    <div className="space-y-2">
                      {emergencyDetails.responses.map((resp) => {
                        ...
                        return (
                          <div 
                            key={resp.id} 
                            className="p-3 bg-white border-slate-200 shadow-sm dark:bg-zinc-950 border border-slate-150 dark:border-zinc-850 rounded-2xl flex items-center justify-between text-xs"
                          >
