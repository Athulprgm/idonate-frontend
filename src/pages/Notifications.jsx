    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 px-6 pt-6 pb-24 select-none">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate(-1)}
            className="w-9 h-9 bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-xl flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 transition-all text-slate-800 dark:text-zinc-100"
          >
      ...
      {notifications.length === 0 ? (
        <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-12 text-center text-slate-400">
