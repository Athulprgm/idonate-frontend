...
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) return (
    <div className="bg-white border-slate-200 shadow-sm border rounded-xl p-3 shadow-xl text-xs">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-red-600 uppercase text-xl sm:text-2xl font-black tracking-tight">Reports & Analytics</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <motion.div key={label} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            className="bg-white border-slate-200 shadow-sm border rounded-2xl p-4">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        {/* Monthly Area */}
        <div className="lg:col-span-2 bg-white border-slate-200 shadow-sm border rounded-2xl p-5">
        ...
        {/* Success Rate Donut */}
        <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-5">
