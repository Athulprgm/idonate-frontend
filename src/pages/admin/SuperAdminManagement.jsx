  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 sm:px-5 py-2.5 sm:py-3 bg-white border-slate-200 shadow-sm text-emerald-900 hover:bg-emerald-50 rounded-2xl text-xs font-black transition flex items-center gap-2 cursor-pointer transform hover:scale-105"
            >
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border-slate-200 shadow-sm border border-red-100 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="bg-white border-slate-200 shadow-sm border border-red-100 rounded-3xl overflow-hidden">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white border-slate-200 shadow-sm rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden border max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    {createdResult.password && (
                      <div className="mt-2 bg-white border-slate-200 shadow-sm border border-emerald-200 rounded-xl p-3.5 space-y-2 text-slate-800">
                ...
                <div>
                  ...
                  {district === 'Other' && (
                    <input
                      ...
                      required
                      className="w-full bg-white border-slate-200 shadow-sm border rounded-xl px-3.5 py-2.5 mt-2 text-xs font-semibold text-slate-900 focus:outline-none focus:ring-1 focus:ring-primary"
                    />
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-white border-slate-200 shadow-sm border rounded-xl px-3 py-2 text-xs font-semibold text-slate-900 focus:outline-none focus:ring-1 focus:ring-primary"
                      />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white border-slate-200 shadow-sm border rounded-xl px-3 py-2 focus:border-red-500"
                    />
                  </div>
                  <div>
